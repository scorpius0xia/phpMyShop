    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-1 table-item">
                <p class="text-center "><?php echo $row->gamount;?></p>
            </div>
            <div class="col-md-2 table-item">
                <p class="text-center"><?php echo $row->gprice;?></p>
            </div>
            <div class="col-md-1 table-item">
                <p class="text-center"><a href="<?php echo site_url('index/item_fall/'.$row->gid);?>">下架</a></p>
            </div>
        </div>
        <?php }?>
    </div>
